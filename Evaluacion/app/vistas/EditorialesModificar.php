...
<body>
  <form action='<?php print RUTA_APP . "editoriales/modificar/"; ?>' method="POST">
    <div class="container">
      <div class="row">
      ...
      <table class="table">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="nom_editorial" name="nom_editorial" value="<?php print $data["nom_editorial"]; ?>">
        </div>
        <tr>
