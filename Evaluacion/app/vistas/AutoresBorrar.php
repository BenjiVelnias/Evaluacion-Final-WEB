...
<body>
  <form action='<?php print RUTA_APP . "autores/borrar/"; ?>' method="POST">
    <div class="container">
      <div class="row">
      ...
      <div class="mb-3">
          ...
          <input type="text" class="form-control" id="nom_autor" name="nom_autor" disabled="disabled" value="<?php print $data["nom_autor"]; ?>">
        </div>
        <tr>
